...
<ul class="pagination justify-content-center">
  ...
  <li class="page-item <c:if test="${!pm.next}">disabled</c:if>"><a class="page-link" href="<%=request.getContextPath()%>/board/list?page=${pm.startPage+1}&search=${pm.cri.search}&type=${pm.cri.type}">Next</a></li>
</ul>
<!-- 페이지네이션 end -->
...
<div class="input-group mb-3">
	<select class = "form-control" name ="type">
		<c:if test ="${pm.cri.type == 0 }">selected</c:if>
